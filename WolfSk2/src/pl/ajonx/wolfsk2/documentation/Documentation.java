package pl.gempxplay.wolfsk2.utils.doc;
...
public class Documentation {
    ...
    private static File doc = new File(WolfSk2.plugin.getDataFolder() + File.separator + "doc");
    ...
    private static void css() {
        InputStream css = WolfSk2.plugin.getResource("doc/css/style.css");
        InputStream bebas = WolfSk2.plugin.getResource("doc/css/BebasNeueRegular.ttf");
        InputStream kirvy = WolfSk2.plugin.getResource("doc/css/Kirvy-Regular.otf");
        InputStream icon = WolfSk2.plugin.getResource("doc/css/favicon.ico");
    ...
    private static InputStream resource(String dir) {
        return WolfSk2.plugin.getResource(dir);
    }
